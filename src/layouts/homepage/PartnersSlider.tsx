    ...
    <div className="relative">
      <div className="flex flex-col sm:flex-row sm:items-start justify-center sm:justify-between text-center sm:text-left mb-10">
        ...
        <div className="flex items-center gap-4 justify-between pt-5 sm:pt-0">
          <button className="px-6 py-2 border-2 rounded-full border-brand-400 flex items-center gap-2 font-medium w-[195px] cursor-pointer group/feedback hover:border-accent transition-all duration-300">
