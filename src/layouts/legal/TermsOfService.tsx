...
const sections = [
  ...
  { id: "site-access", label: "Access" },
  { id: "indemnification", label: "Indemnification" },
  { id: "third-party", label: "Third-Party Links & Ads" },
  { id: "disclaimers", label: "Disclaimers" },
  { id: "liability", label: "Limitation on Liability" },
  { id: "term-termination", label: "Term and Termination" },
  { id: "changes", label: "Changes to Terms" },
  { id: "dispute-resolution", label: "Dispute Resolution" },
  { id: "export", label: "Export" },
  { id: "disclosures", label: "Disclosures" },
  { id: "communications", label: "Electronic Communications" },
  { id: "entire-terms", label: "Entire Terms" },
  { id: "copyright-trademark-information", label: "Copyright Information" },
      ...
      <div className="p-6">
        ...
        <div className="text-color font-normal leading-6 space-y-4">
          <section id="welcome" className="scroll-mt-">
            <div className="space-y-2">
              <p className="mb-6 text-sm">
                The website located at www.theopenlane.io (the <b>Site</b>) is a
                copyrighted work belonging to theopenlane, Inc. (
                <b>"Company"</b>,<b>"us"</b>, <b>"our"</b>, and <b>"we"</b>).
              ...
              <p className="mb-6 text-sm">
                ...
                binding terms and conditions that govern your use of the Site.
                ...
                the entity that you represent). you may not access or use the
                Site or accept the Terms if you are not at least 18 years old.
                If you do not agree with all of the provisions of these Terms,
                do not access and/or use the Site.
              </p>
              <p className="mb-6 text-sm font-bold">
                PLEASE BE AWARE THAT SECTION 8.2 CONTAINS PROVISIONS GOVERNING
                HOW TO RESOLVE DISPUTES BETWEEN YOU AND COMPANY. AMONG OTHER
                THINGS, SECTION 8.2 INCLUDES AN AGREEMENT TO ARBITRATE WHICH
                REQUIRES, WITH LIMITED EXCEPTIONS, THAT ALL DISPUTES BETWEEN YOU
                AND US SHALL BE RESOLVED BY BINDING AND FINAL ARBITRATION.
                SECTION 8.2 ALSO CONTAINS A CLASS ACTION AND JURY TRIAL WAIVER.
              ...
              <p className="mb-6 text-sm font-bold">
                ...
                OR PROCEEDING AND YOU WAIVE YOUR RIGHT TO PARTICIPATE IN A CLASS
                ACTION LAWSUIT OR CLASS-WIDE ARBITRATION; AND (2) YOU ARE
                WAIVING YOUR RIGHT TO PURSUE DISPUTES OR CLAIMS AND SEEK RELIEF
          ...
          <section id="accounts" className="scroll-mt-4">
            ...
            <div className="space-y-2">
              <p className="mb-6 text-sm">
                1.1. <b>Account Creation.</b> In order to use certain features
                of the Site, you must register for an account (“<b>Account</b>”)
                and provide certain information about yourself as prompted by
                the account registration form. You represent and warrant that:
                ...
                reason, by following the instructions on the Site. Company may
                suspend or terminate your Account in accordance with Section 7.
              </p>
              <p className="mb-6 text-sm">
                1.2. <b>Account Responsibilities.</b> You are responsible for
                ...
                Company of any unauthorized use, or suspected unauthorized use
                of your Account or any other breach of security. Company cannot
                and will not be liable for any loss or damage arising from your
                failure to comply with the above requirements.
              </p>
            </div>
          </section>
          <section id="site-access" className="scroll-mt-4">
            <h4>2. Access to the Site</h4>
            <div className="space-y-2">
              <p className="mb-6 text-sm">
                2.1. <b>License.</b> Subject to these Terms, Company grants you
                a non-transferable, non-exclusive, revocable, limited license to
                use and access the Site solely for your own personal,
                noncommercial use.
              </p>
              <p className="mb-6 text-sm">
                2.2. <b>Certain Restrictions.</b> The rights granted to you in
                ...
                Site; (c) you shall not access the Site in order to build a
                similar or competitive website, product, or service; and (d)
              ...
              <p className="mb-6 text-sm">
                2.3. <b>Modification.</b> Company reserves the right, at any
                time, to modify, suspend, or discontinue the Site (in whole or
                in part) with or without notice to you. You agree that Company
                will not be liable to you or to any third party for any
                modification, suspension, or discontinuation of the Site or any
                part thereof.
              </p>
              <p className="mb-6 text-sm">
                2.4. <b>No Support or Maintenance.</b> You acknowledge and agree
                that Company will have no obligation to provide you with any
                support or maintenance in connection with the Site.
              </p>
              <p className="mb-6 text-sm">
                2.5. <b>Ownership.</b> You acknowledge that all the intellectual
                property rights, including copyrights, patents, trade marks, and
                trade secrets, in the Site and its content are owned by Company
                or Company’s suppliers. Neither these Terms (nor your access to
                the Site) transfers to you or any third party any rights, title
                or interest in or to such intellectual property rights, except
                for the limited access rights expressly set forth in Section
                2.1. Company and its suppliers reserve all rights not granted in
                these Terms. There are no implied licenses granted under these
                Terms.
              </p>
              <p className="mb-6 text-sm">
                2.6. <b>Feedback.</b> If you provide Company with any feedback
                or suggestions regarding the Site ("<b>Feedback</b>"), you
          ...
          <section id="indemnification" className="scroll-mt-4">
            ...
            <div className="space-y-2">
              <p className="mb-6 text-sm">
                3.1. You agree to indemnify and hold Company (and its officers,
                ...
                these Terms or (c) your violation of applicable laws or
                regulations. Company reserves the right, at your expense, to
                assume the exclusive defense and control of any matter for which
                you are required to indemnify us, and you agree to cooperate
                with our defense of these claims. You agree not to settle any
                matter without the prior written consent of Company. Company
          ...
          <section id="third-party" className="scroll-mt-4">
            <h4>4. Third-Party Links & Ads; Other Users</h4>
            <div className="space-y-2">
              <p className="mb-6 text-sm">
                4.1. <b>Third-Party Links & Ads.</b> The Site may contain links
                ...
                Links & Ads. Company provides access to these Third-Party Links
                ...
                of caution and discretion in doing so. When you click on any of
                the Third-Party Links & Ads, the applicable third party’s terms
              ...
              <p className="mb-6 text-sm">
                4.2. <b>Other Users.</b> Your interactions with other Site users
              ...
              <p className="mb-6 text-sm">
                4.3. <b>Release.</b> You hereby release and forever discharge
                ...
                every kind and nature (including personal injuries, death, and
                property damage), that has arisen or arises directly or
                indirectly out of, or that relates directly or indirectly to,
                the Site (including any interactions with, or act or omission
                of, other Site users or any Third-Party Links & Ads). IF YOU ARE
          ...
          <section id="disclaimers" className="scroll-mt-4">
            <h4>5. Disclaimers</h4>
            <div className="space-y-2">
              <p className="mb-6 text-sm">
                ...
                WARRANTIES ARE LIMITED IN DURATION TO 90 DAYS FROM THE DATE OF
                FIRST USE.
              </p>
              <p className="mb-6 text-sm">
          ...
          <section id="liability" className="scroll-mt-4">
            ...
            <div className="space-y-2">
              ...
              <p className="mb-6 text-sm">
                ...
                ALL TIMES BE LIMITED TO A MAXIMUM OF FIFTY US DOLLARS. THE
          ...
          <section id="term-termination" className="scroll-mt-4">
            ...
            <div className="space-y-2">
              <p className="mb-6 text-sm">
                ...
                use the Site will terminate immediately. Company will not have
                any liability whatsoever to you for any termination of your
                rights under these Terms, including for termination of your
                Account. Even after your rights under these Terms are
                terminated, the following provisions of these Terms will remain
                in effect: Sections 2.2 through 2.6 and Sections 3 through 8.
              </p>
            </div>
          </section>
          ...
          <section id="changes" className="scroll-mt-4">
            ...
            <div className="space-y-2">
              <p className="mb-6 text-sm">
                ...
                you have provided us is not valid, or for any reason is not
                ...
                notice. Continued use of our Site following notice of such
          ...
          <section id="dispute-resolution" className="scroll-mt-4">
            ...
            <div className="space-y-2">
              <p className="mb-6 text-sm">
                ...
                (the “<b>Arbitration Agreement</b>”) carefully. It requires you
                to arbitrate disputes with Company, its parent companies,
                subsidiaries, affiliates, successors and assigns and all of
                their respective officers, directors, employees, agents, and
                representatives (collectively, the “<b>Company Parties</b>”) and
                limits the manner in which you can seek relief from the Company
                Parties.
              </p>
              <h5>9.1. Applicability of Arbitration Agreement</h5>
              <p className="mb-6 text-sm">
                ...
                the Site (the “<b>Services</b>”) or these Terms will be resolved
                by binding arbitration, rather than in court, except that (1)
                you and the Company Parties may assert individualized claims in
                small claims court if the claims qualify, remain in such court
                and advance solely on an individual, non-class basis; and (2)
                you or the Company Parties may seek equitable relief in court
                ...
                <b>
                  ...
                  you agreed to these Terms (in accordance with the preamble) or
                  any prior version of these Terms.
                </b>{" "}
                ...
                Agreement, “<b>Dispute</b>” will also include disputes that
                arose or involve facts occurring before the existence of this or
                any prior versions of the Agreement as well as claims that may
                arise after the termination of these Terms.
              </p>
              <h5>9.2. Informal Dispute Resolution</h5>
              <p className="mb-6 text-sm">
                There might be instances when a Dispute arises between you and
                Company. If that occurs, Company is committed to working with
                you to reach a reasonable resolution. You and Company agree that
                good faith informal efforts to resolve Disputes can result in a
                prompt, low‐cost and mutually beneficial outcome. You and
                Company therefore agree that before either party commences
                ...
                confer telephonically or via video conference, in a good faith
                effort to resolve informally any Dispute covered by this
                Arbitration Agreement (“
                <b>Informal Dispute Resolution Conference”</b>). If you are
              ...
              <p className="mb-6 text-sm">
                ...
                Resolution Conference (“<b>Notice</b>”), which shall occur
                ...
                info@theopenlane.io, or by regular mail to 5150 Broadway St.,
                San Antonio, Texas 78209. The Notice must include: (1) your
              ...
              <h5>9.3. Arbitration Rules and Forum</h5>
              <p className="mb-6 text-sm">
                ...
                calling JAMS at 800-352-5267. A party who wishes to initiate
                arbitration must provide the other party with a request for
                arbitration (the “<b>Request</b>”). The Request must include:
                (1) the name, telephone number, mailing address, e‐mail address
                of the party seeking arbitration and the account username (if
                applicable) as well as the email address associated with any
                applicable account; (2) a statement of the legal claims being
                asserted and the factual bases of those claims; (3) a
              ...
              <p className="mb-6 text-sm">
                ...
                Subject to the JAMS Rules, the arbitrator may direct a limited
                and reasonable exchange of information between the parties,
                consistent with the expedited nature of the arbitration. If the
                JAMS is not available to arbitrate, the parties will select an
                alternative arbitral forum. Your responsibility to pay any JAMS
                fees and costs will be solely as set forth in the applicable
                JAMS Rules.
              </p>
              <p className="mb-6 text-sm">
                You and Company agree that all materials and documents exchanged
                during the arbitration proceedings shall be kept confidential
                and shall not be shared with anyone except the parties’
                attorneys, accountants, or business advisors, and then subject
                to the condition that they agree to keep all materials and
                documents exchanged during the arbitration proceedings
                confidential.
              </p>
              <h5>9.4. Authority of Arbitrator</h5>
              <p className="mb-6 text-sm">
                ...
                Agreement or any portion of the Arbitration Agreement, except
                for the following: (1) all Disputes arising out of or relating
                to the subsection entitled “Waiver of Class or Other
                Non-Individualized Relief,” including any claim that all or part
                of the subsection entitled “Waiver of Class or Other
                Non-Individualized Relief” is unenforceable, illegal, void or
                voidable, or that such subsection entitled “Waiver of Class or
                ...
                Disputes about which version of the Arbitration Agreement
              ...
              <h5>9.5. Waiver of Jury Trial</h5>
              <p className="mb-6 text-sm">
                EXCEPT AS SPECIFIED in section 8.2(a) YOU AND THE COMPANY
                PARTIES HEREBY WAIVE ANY CONSTITUTIONAL AND STATUTORY RIGHTS TO
                SUE IN COURT AND HAVE A TRIAL IN FRONT OF A JUDGE OR A JURY. You
                and the Company Parties are instead electing that all covered
                ...
                same damages and relief as a court and must follow these Terms
              ...
              <h5>9.6. Waiver of Class or Other Non-Individualized Relief</h5>
              <p className="mb-6 text-sm">
                ...
                and conditions under the Subsection 8.2(h) entitled “Batch
                ...
                located in the State of Texas. All other Disputes shall be
                arbitrated or litigated in small claims court. This subsection
                does not prevent you or Company from participating in a
                class-wide settlement of claims.
              </p>
              <h5>9.7. Attorneys’ Fees and Costs</h5>
              <p className="mb-6 text-sm">
                ...
                11(b)). If you or Company need to invoke the authority of a
                court of competent jurisdiction to compel arbitration, then the
                party that obtains an order compelling arbitration in such
                ...
                arbitration, including the Informal Dispute Resolution Process,
                is entitled to recover their reasonable costs, necessary
                disbursements, and reasonable attorneys’ fees and costs.
              </p>
              <h5>9.8. Batch Arbitration</h5>
              <p className="mb-6 text-sm">
                ...
                nature filed against Company by or with the assistance of the
                same law firm, group of law firms, or organizations, within a 30
                day period (or as soon as possible thereafter), the JAMS shall
                (1) administer the arbitration demands in batches of 100
                ...
                batch consisting of the remaining Requests); (2) appoint one
              ...
              <p className="mb-6 text-sm">
                ...
                disagree on the application of the Batch Arbitration process,
                the disagreeing party shall advise the JAMS, and the JAMS shall
                appoint a sole standing arbitrator to determine the
                applicability of the Batch Arbitration process (“
                <b>Administrative Arbitrator</b>”). In an effort to expedite
                resolution of any such dispute by the Administrative Arbitrator,
                the parties agree the Administrative Arbitrator may set forth
                such procedures as are necessary to resolve any disputes
                promptly. The Administrative Arbitrator’s fees shall be paid by
                Company.
              </p>
              <p className="mb-6 text-sm">
                You and Company agree to cooperate in good faith with the JAMS
                to implement the Batch Arbitration process including the payment
                of single filing and administrative fees for batches of
              ...
              <p className="mb-6 text-sm">
                ...
                as authorizing a class, collective and/or mass arbitration or
              ...
              <h5>9.9. 30-Day Right to Opt Out</h5>
              <p className="mb-6 text-sm">
                You have the right to opt out of the provisions of this
                Arbitration Agreement by sending a timely written notice of your
                decision to opt out to the following address: 5150 Broadway St.,
                San Antonio, Texas 78209, or email to info@theopenlane.io,
              ...
              <h5>9.10. Invalidity, Expiration</h5>
              <p className="mb-6 text-sm">
                Except as provided in the subsection entitled “Waiver of Class
                or Other Non-Individualized Relief”, if any part or parts of
                ...
                the Arbitration Agreement shall continue in full force and
                effect. You further agree that any Dispute that you have with
                Company as detailed in this Arbitration Agreement must be
                initiated via arbitration within the applicable statute of
                limitation for that claim or controversy, or it will be forever
                time barred. Likewise, you agree that all applicable statutes of
                limitation will apply to such arbitration in the same manner as
                those statutes of limitation would apply in the applicable court
          ...
          <section id="modification">
            ...
            <p className="mb-6 text-sm">
              ...
              following address: 5150 Broadway St., San Antonio, Texas 78209, or
              email to info@theopenlane.io. Unless you reject the change within
              30 days of such change becoming effective by writing to Company in
              ...
              offered on the Site following the posting of changes to this
          ...
          <section id="communications">
            <h4>13. Electronic Communications</h4>
            <p className="mb-6 text-sm">
          ...
          <section id="entire-terms">
            <h4>14. Entire Terms</h4>
            <p className="mb-6 text-sm">
          ...
          <section id="copyright-trademark-information">
            <h4>15. Copyright/Trademark Information</h4>
            <p className="mb-6 text-sm">
              Copyright © 2025 theopenlane, Inc. All rights reserved. All
              trademarks, logos and service marks (“<b>Marks</b>”) displayed on
              the Site are our property or the property of other third parties.
                ...
                <div className="text-sm">
                  ...
                  <div className="mt-1">
                    ...
                    <div>
                      ...
                      <a href="tel:7207386846" className="hover:underline">
                        (720) 738-6846
                      </a>
                    </div>
                  </div>
