...
const sections = [
  ...
  { id: "data-use", label: "Information Use" },
  { id: "data-retention", label: "Data Retention" },
  { id: "data-transfer", label: "Transfer of Data" },
  { id: "data-disclosure", label: "Disclosure of Data" },
  { id: "data-security", label: "Security of Data" },
  { id: "gdpr-rights", label: "GDPR Rights" },
  { id: "caloppa-rights", label: "CalOPPA Rights" },
      ...
      <main className="p-6">
        ...
        <div className="text-color font-normal leading-6">
          <section id="introduction">
            <h4 className="pt-4">
              <a href="#introduction" className="hover:text-color-primary">
                Introduction
              </a>
            </h4>
            <p className="mb-2 text-sm">
              theopenlane, Inc. ("<b>us</b>", "<b>we</b>", or "<b>our</b>")
              operates https://theopenlane.io (hereinafter referred to as "
              <b>Service</b>").
            </p>

            <p className="mb-2 text-sm">
              Our Privacy Policy governs your visit to https://theopenlane.io,
          ...
          <section id="definitions">
            <h4 className="pt-4">
              <a href="#definitions" className="hover:text-color-primary">
                Definitions
              </a>
            </h4>
            <p className="mb-2 text-sm">
              <b>SERVICE</b> means the https://theopenlane.io website operated
              by theopenlane, Inc.
            </p>
            ...
            <p className="mb-2 text-sm">
              ...
              we are a <b>Data Controller</b> of your data.
            </p>
          ...
          <section id="data-types">
            <h5 className="pt-4">Types of Data Collected</h5>
            ...
            <p className="mb-2 text-sm">
              ...
              ZIP/Postal code, City Cookies and Usage Data We may use your
          ...
          <section id="data-use">
            <h4 className="pt-4">
              <a href="#data-use" className="hover:text-color-primary">
                Use of Data
              </a>
            </h4>
            <p className="mb-2 text-sm">
            ...
            <ul className="list-disc pl-8 mb-6 space-y-2 text-sm">
          ...
          <section id="data-retention">
            <h4 className="pt-4">
              <a href="#data-retention" className="hover:text-color-primary">
                Retention of Data
              </a>
            </h4>
            <p className="mb-2 text-sm">
          ...
          <section id="data-transfer">
            <h4 className="pt-4">
              <a href="#data-transfer" className="hover:text-color-primary">
                Transfer of Data
              </a>
            </h4>
            <p className="mb-2 text-sm">
            ...
            <p className="mb-2 text-sm">
              theopenlane, Inc. will take all the steps reasonably necessary to
          ...
          <section id="data-disclosure">
            <h4 className="pt-4">
              <a href="#data-disclosure" className="hover:text-color-primary">
                Disclosure of Data
              </a>
            </h4>
            <p className="mb-2 text-sm">
          ...
          <section id="data-security">
            <h4 className="pt-4">
              <a href="#data-security" className="hover:text-color-primary">
                Security of Data
              </a>
            </h4>
            <p className="mb-2 text-sm">
          ...
          <section id="gdpr-rights">
            <h4 className="pt-4">
              <a href="#gdpr-rights" className="hover:text-color-primary">
          ...
          <section id="caloppa-rights">
            <h4 className="pt-4">
              <a href="#caloppa" className="hover:text-color-primary">
            ...
            <ul className="list-disc pl-8 mb-6 space-y-2 text-sm">
              ...
              <li>
                ...
                us at support@theopenlane.io.
              </li>
            </ul>
            <h5 className="text-base font-semibold mb-2">
              <a href="#do-not-track" className="hover:text-color-primary">
                Our Policy on "Do Not Track" Signals
              </a>
            </h5>
            <p className="mb-2 text-sm">
              We honor "<b>Do Not Track</b>" signals and do not track, plant
              cookies, or use advertising when a "<b>Do Not Track</b>" browser
              mechanism is in place. "<b>Do Not Track</b>" is a preference you
              can set in your web browser to inform websites that you do not
              want to be tracked.
            </p>
            <p className="mb-2 text-sm">
              You can enable or disable "<b>Do Not Track</b>" by visiting the
          ...
          <section id="ccpa-rights">
            <h4 className="pt-4">
              <a href="#ccpa" className="hover:text-color-primary">
            ...
            <p className="mb-2 text-sm">
              a) <b>What personal information we have about you.</b>
            </p>
            <p className="mb-2 text-sm">
            ...
            <p className="mb-2 text-sm">
              c) <b>To stop selling your personal information</b>
            </p>
            <p className="mb-2 text-sm">
            ...
            <p className="mb-2 text-sm">
              <b>By email:</b> support@theopenlane.io
            </p>
            <p className="mb-2 text-sm">
          ...
          <section id="service-providers">
            <h4 className="pt-4">
              <a href="#service-providers" className="hover:text-color-primary">
                Service Providers
              </a>
            </h4>
            <p className="mb-2 text-sm">
            ...
            <h5 className="pt-4">CI/CD tools</h5>
            <p className="mb-2 text-sm">
              We may use third-party Service Providers to automate the
              development process of our Service.
            </p>
            <p className="text-base font-semibold mb-2">Buildkite</p>
            <p className="mb-2 text-sm">
              Buildkite is Continuous Integration, a development practice which
            ...
            <p className="mb-2 text-sm">
              For more information on what data Buildkite collects for what
              purpose and how the protection of the data is ensured, please
              visit Buildkite Privacy Policy page:{" "}
              <a
                href="https://buildkite.com/privacy-policy"
                target="_blank"
                rel="noopener noreferrer"
              >
                https://buildkite.com/privacy-policy
              </a>
            </p>

            <h5 className="pt-4">Payments</h5>
            <p className="mb-2 text-sm">
            ...
            <p className="text-base font-semibold mb-2">Stripe</p>
            <p className="mb-2 text-sm">
          ...
          <section id="links">
            <h4 className="pt-4">
              <a href="#links" className="hover:text-color-primary">
          ...
          <section id="childrens-privacy">
            <h4 className="pt-4">
              <a href="#childrens-privacy" className="hover:text-color-primary">
                Children's Privacy
              </a>
            </h4>
            <p className="mb-2 text-sm">
          ...
          <section id="changes">
            <h4 className="pt-4">
              <a href="#changes" className="hover:text-color-primary">
