          ...
          <div className="text-color font-normal leading-6">
            ...
            <section id="definitions">
              ...
              <p className="mb-2 text-sm">
                ...
                this Privacy Policy, we are a <b>Data Controller</b> of your
                data.
              </p>
            ...
            <section id="data-transfer">
              ...
              <p className="mb-2 text-sm">
                theopenlane, Inc. will take all the steps reasonably necessary
            ...
            <section id="caloppa-rights">
              ...
              <ul className="list-disc pl-8 mb-6 space-y-2 text-sm">
                ...
                <li>
                  ...
                  emailing us at support@theopenlane.io.
                </li>
              </ul>
            ...
            <section id="service-providers">
              ...
              <p className="mb-2 text-sm">
                Buildkite is Continuous Integration, a development practice
